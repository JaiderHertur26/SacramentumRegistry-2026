...
const ImportMarriagesForm = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Importar Matrimonios">
        <div className="space-y-6 min-w-[600px]">
            ...
            <div className="flex justify-end gap-3 pt-2 border-t">
                ...
                <Button onClick={handleConfirm} disabled={!validationResult || validationResult.count === 0} className="bg-yellow-500 hover:bg-yellow-600 text-white">
