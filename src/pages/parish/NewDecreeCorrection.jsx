      ...
      try {
          if (type === 'bautismo') {
              ...
              const newPartidaRecord = {
                  ...bautismoNewPartida, id: newPartidaId, parishId,
                  ...
                  conceptoAnulacionId: bautismoDecree.conceptoAnulacionId, tipoNotaAlMargen: 'porCorreccion.nuevaPartida', createdAt: new Date().toISOString()
              };
              ...
              const marginalNote = updateBaptismPartidaMarginalNote(bautismoFound.id, { numero: bautismoDecree.numeroDecreto, fecha: bautismoDecree.fechaDecreto, libro: newPartidaRecord.book_number, folio: newPartidaRecord.page_number }, null);
              
              allBaptisms[originalIndex] = {
                  ...allBaptisms[originalIndex], isAnnulled: true, status: 'anulada', annulmentDecree: bautismoDecree.numeroDecreto,
                  annulmentDate: bautismoDecree.fechaDecreto, conceptoAnulacionId: bautismoDecree.conceptoAnulacionId,
                  tipoNotaAlMargen: 'porCorreccion.anulada', notaMarginal: marginalNote, updatedAt: new Date().toISOString()
              };
              ...
              existingCorrections.push({
                  ...
                  conceptoAnulacionId: bautismoDecree.conceptoAnulacionId, parroquia: user.parishName, targetName: `${bautismoFound.firstName} ${bautismoFound.lastName}`,
                  book: bautismoFound.book_number, page: bautismoFound.page_number, entry: bautismoFound.entry_number,
                  originalPartidaId: bautismoFound.id, newPartidaId: newPartidaId,
                  originalPartidaSummary: { ...bautismoFound, book: bautismoFound.book_number, page: bautismoFound.page_number, entry: bautismoFound.entry_number },
              ...
              const newRecord = {
                  ...confirmacionNewPartida, id: newId, parishId,
                  book_number: params.suplementarioLibro, page_number: params.suplementarioFolio, entry_number: params.suplementarioNumero,
              ...
              const note = `PARTIDA ANULADA POR DECRETO No. ${confirmacionDecree.numeroDecreto} DE FECHA ${confirmacionDecree.fechaDecreto}. VER LIBRO ${newRecord.book_number} FOLIO ${newRecord.page_number} NUMERO ${newRecord.entry_number}.`;
              ...
              existingCorrections.push({
                  ...
                  conceptoAnulacionId: confirmacionDecree.conceptoAnulacionId, targetName: `${confirmacionFound.firstName} ${confirmacionFound.lastName}`,
              ...
              const newId = generateUUID();
              const newRecord = {
                  ...matrimonioNewPartida, id: newId, parishId,
                  book_number: params.suplementarioLibro, page_number: params.suplementarioFolio, entry_number: params.suplementarioNumero,
              ...
              const note = `MATRIMONIO ANULADO POR DECRETO No. ${matrimonioDecree.numeroDecreto} DE FECHA ${matrimonioDecree.fechaDecreto}. VER LIBRO ${newRecord.book_number} FOLIO ${newRecord.page_number} NUMERO ${newRecord.entry_number}.`;
              ...
              existingCorrections.push({
                  ...
                  conceptoAnulacionId: matrimonioDecree.conceptoAnulacionId, targetName: `${matrimonioFound.husbandSurname} - ${matrimonioFound.wifeSurname}`,
