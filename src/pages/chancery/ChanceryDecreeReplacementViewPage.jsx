...
const ChanceryDecreeReplacementViewPage = () => {
  ...
  const loadData = () => {
      ...
      for (let i = 0; i < localStorage.length; i++) {
          ...
          // EL FILTRO CLAVE: Buscamos llaves de reposición, pero SOLO si incluyen el ID de Cancillería.
          // Esto ignora automáticamente las llaves como "decreeReplacementBaptism_parroquia123"
